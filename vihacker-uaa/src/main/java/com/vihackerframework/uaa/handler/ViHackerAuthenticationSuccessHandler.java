package com.vihackerframework.uaa.handler;
 ...
 */
@Slf4j
public class ViHackerAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException {
        ...
        // 直接结束
        response.setContentType(ViHackerConstant.JSON_UTF8);
