 ...
 */
public class ViHackerUserInfoTokenServices implements ResourceServerTokenServices {
    ...
    public ViHackerUserInfoTokenServices(String userInfoEndpointUrl, String clientId) {
    ...
    private Map<String, Object> getMap(String path, String accessToken) {
        ...
        try {
            ...
            ResponseEntity<Map> forEntity = restTemplate.getForEntity(path, Map.class, new Object[0]);
